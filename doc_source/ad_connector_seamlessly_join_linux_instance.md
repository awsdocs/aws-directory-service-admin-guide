...
1. Under **Secret name**, enter a secret name that includes your directory ID using the **aws/directory\-services/*d\-xxxxxxxxx*/seamless\-domain\-join**\ format. This will be used to retrieve secrets in the application\.
**Note**  
