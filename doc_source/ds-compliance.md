# Compliance Validation for AWS Directory Service<a name="ds-compliance"></a>

Third\-party auditors assess the security and compliance of AWS Directory Service as part of multiple AWS compliance programs\. With AWS Managed Microsoft AD, these include SOC, PCI, FedRAMP, HIPAA, and others\. For more information, see [Manage Compliance for AWS Managed Microsoft AD](ms_ad_compliance.md)\.
...
You can use AWS Artifact to download third\-party audit reports\. For more information, see [Downloading Reports in AWS Artifact](https://docs.aws.amazon.com/artifact/latest/ug/downloading-documents.html)\.
