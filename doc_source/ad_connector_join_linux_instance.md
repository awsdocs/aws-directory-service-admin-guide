# Manually Join a Linux Instance<a name="ad_connector_join_linux_instance"></a>

In addition to Amazon EC2 Windows instances, you can also join certain Amazon EC2 Linux instances to your connected directory\. The following Linux instance distributions and versions are supported:
...
## Join an Instance to Your Directory<a name="ad_connector_join_linux_prereq"></a>
...
## Restricting Account Login Access<a name="ad_connector_linux_filter"></a>
