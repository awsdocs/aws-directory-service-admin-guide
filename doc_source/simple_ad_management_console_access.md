# Enable access to the AWS Management Console with AD credentials<a name="simple_ad_management_console_access"></a>
...
**Topics**
+ [Enable AWS Management Console access](#simple_ad_console_enable)
+ [Disable AWS Management Console access](#simple_ad_console_disable)
+ [Set login session length](#simple_ad_console_session)
...
## Enable AWS Management Console access<a name="simple_ad_console_enable"></a>
...
## Disable AWS Management Console access<a name="simple_ad_console_disable"></a>
...
## Set login session length<a name="simple_ad_console_session"></a>
