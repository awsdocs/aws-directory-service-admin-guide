# Reset a User Password<a name="simple_ad_manage_users_groups_reset_password"></a>
...
+ For Simple AD, you cannot reset the password for any user that is a member of the **Domain Admins** group except for the Administrator user\.
