...
Client\-side LDAPS support in AWS Managed Microsoft AD encrypts communications between Microsoft Active Directory \(AD\) and AWS applications\. Examples of such applications include WorkSpaces, AWS IAM Identity Center \(successor to AWS Single Sign\-On\), Amazon QuickSight, and Amazon Chime\. This encryption helps you to better protect your organization’s identity data and meet your security requirements\.
...
### Step 2: Check registration status<a name="ms_ad_check-registration-status"></a>
