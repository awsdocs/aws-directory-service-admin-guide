...
See [AWS Regions and Endpoints](https://docs.aws.amazon.com/general/latest/gr/rande.html#ds_region) documentation for a list of supported directory types per region\.
